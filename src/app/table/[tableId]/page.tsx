...
import { Search, ShoppingBag, BellRing, Receipt, Flame, Leaf, Sparkles, Check, ChevronRight } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-950 text-white font-sans pb-24">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className="text-xs uppercase font-bold tracking-widest text-amber-400">Digital Dining</span>
                <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-pulse" />
              </div>
              <h1 className="text-xl font-extrabold tracking-tight">Table {tableNumber} Menu</h1>
            </div>
          </div>
      ...
      <div className="max-w-4xl mx-auto px-4 pt-4 space-y-3">
        <div className="relative">
          ...
          <input
            type="text"
            placeholder="Search appetizers, steaks, pasta, drinks..."
            value={searchQuery}
                    ...
                    <div className="flex items-center justify-between pt-2">
                      ...
                      {dish.isAvailable && (
                        ...
                        >
                          {inCartCount > 0 ? (
                            <>
                              <Check className="w-3.5 h-3.5 stroke-[3]" /> Added ({inCartCount})
                            </>
                          ) : (
                            '+ Add Dish'
                          )}
        ...
        <div className="fixed bottom-4 left-4 right-4 z-40 max-w-lg mx-auto">
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm font-black tracking-wide">View Order Ticket</span>
            </div>
